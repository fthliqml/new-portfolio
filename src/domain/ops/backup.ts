...
export const cmsBackupPayloadSchema = z.object({
  ...
  resumeAssets: z.array(z.object({ id: z.string(), bucket: z.string(), objectPath: z.string(), originalName: z.string(), mimeType: z.literal("application/pdf"), sizeBytes: z.number().int(), createdBy: z.uuid(), createdAt: isoDate, updatedAt: isoDate })).optional(),
  ...
  resumeFiles: z.array(z.object({ resumeAssetId: z.string(), bucket: z.string(), objectPath: z.string(), file: z.string(), sha256: z.string().length(64), sizeBytes: z.number().int() })).optional(),
});
